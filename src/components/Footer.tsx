    ...
    <div className="container mx-auto px-4">
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <a href="mailto:amfasuites@gmail.com" className="block text-primary-foreground/70 hover:text-primary-foreground text-sm transition-colors">amfasuites@gmail.com</a>
          ...
          <p className="text-primary-foreground/70 text-sm mt-1 leading-relaxed">6th King Muhammad Adah Street, Ochacho Homes, Abuja, Idu</p>
        </div>
      </div>
